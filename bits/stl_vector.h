...
extern "C" void __sanitizer_annotate_contiguous_container(const void*,
                                                          const void*,
                                                          const void*,
                                                          const void*);
#endif
...
namespace std _GLIBCXX_VISIBILITY(default) {
  ...
  struct _Vector_base {
    ...
    struct _Vector_impl : public _Tp_alloc_type, public _Vector_impl_data {
      ...
      struct _Asan {
        typedef typename __gnu_cxx::__alloc_traits<_Tp_alloc_type>::size_type
            size_type;

        static _GLIBCXX20_CONSTEXPR void _S_shrink(_Vector_impl&, size_type) {}
      ...
      struct _Asan<allocator<_Up>> {
        ...
        static _GLIBCXX20_CONSTEXPR void _S_adjust(_Vector_impl& __impl,
                                                   pointer __prev,
                                                   pointer __curr) {
          ...
          __sanitizer_annotate_contiguous_container(
              __impl._M_start, __impl._M_end_of_storage, __prev, __curr);
        }

        static _GLIBCXX20_CONSTEXPR void _S_grow(_Vector_impl& __impl,
                                                 size_type __n) {
          _S_adjust(__impl, __impl._M_finish, __impl._M_finish + __n);
        }

        static _GLIBCXX20_CONSTEXPR void _S_shrink(_Vector_impl& __impl,
                                                   size_type __n) {
          _S_adjust(__impl, __impl._M_finish + __n, __impl._M_finish);
        }

        static _GLIBCXX20_CONSTEXPR void _S_on_dealloc(_Vector_impl& __impl) {
          if (__impl._M_start)
...
#define _GLIBCXX_ASAN_ANNOTATE_BEFORE_DEALLOC
  ...
  class vector : protected _Vector_base<_Tp, _Alloc> {
   ...
   public:
     ...
     */
    explicit _GLIBCXX20_CONSTEXPR vector(const allocator_type& __a)
        _GLIBCXX_NOEXCEPT : _Base(__a) {}
     ...
     */
    explicit _GLIBCXX20_CONSTEXPR vector(
        size_type __n, const allocator_type& __a = allocator_type())
   ...
   public:
    ...
    template <typename _InputIterator,
              typename = std::_RequireInputIter<_InputIterator>>
    _GLIBCXX20_CONSTEXPR void assign(_InputIterator __first,
     ...
     *  element order.
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR iterator begin() _GLIBCXX_NOEXCEPT {
     ...
     *  element order.
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_iterator
     ...
     *  element order.
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR iterator end() _GLIBCXX_NOEXCEPT {
     ...
     *  element order.
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reverse_iterator rbegin()
        _GLIBCXX_NOEXCEPT {
     ...
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reverse_iterator
     ...
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reverse_iterator rend()
        _GLIBCXX_NOEXCEPT {
     ...
     *  element order.
     */
    [[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_iterator
     ...
     *  reverse element order.
     */
    [[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_reverse_iterator
    ...
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type
     ...
     *  see at().)
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference operator[](size_type __n)
        _GLIBCXX_NOEXCEPT {
     ...
     *  see at().)
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference
   ...
   public:
     ...
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference front()
        _GLIBCXX_NOEXCEPT {
     ...
     *  element of the %vector.
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference back() _GLIBCXX_NOEXCEPT {
      __glibcxx_requires_nonempty();
      return *(end() - 1);
    }
     ...
     */
    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR _Tp* data() _GLIBCXX_NOEXCEPT {
      return _M_data_ptr(this->_M_impl._M_start);
    }

    _GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const _Tp* data() const
        _GLIBCXX_NOEXCEPT {
      return _M_data_ptr(this->_M_impl._M_start);
    }
     ...
     */
    template <typename... _Args>
    _GLIBCXX20_CONSTEXPR iterator emplace(const_iterator __position,
                                          _Args&&... __args) {
    ...
    template <typename _InputIterator,
              typename = std::_RequireInputIter<_InputIterator>>
    _GLIBCXX20_CONSTEXPR iterator insert(const_iterator __position,
   ...
   protected:
    ...
    _GLIBCXX20_CONSTEXPR pointer _M_allocate_and_copy(size_type __n,
    ...
    template <typename _InputIterator>
    _GLIBCXX20_CONSTEXPR void _M_range_initialize(_InputIterator __first,
                                                  _InputIterator __last,
    ...
    // Called by the second initialize_dispatch above
    template <typename _ForwardIterator>
    _GLIBCXX20_CONSTEXPR void _M_range_initialize(_ForwardIterator __first,
                                                  _ForwardIterator __last,
    ...
    // 438. Ambiguity in the "do the right thing" clause
    template <typename _Integer>
    _GLIBCXX20_CONSTEXPR void _M_assign_dispatch(_Integer __n, _Integer __val,
                                                 __true_type) {
      _M_fill_assign(__n, __val);
    }
    ...
    // Called by the range assign to implement [23.1.1]/9
    template <typename _InputIterator>
    _GLIBCXX20_CONSTEXPR void _M_assign_dispatch(_InputIterator __first,
                                                 _InputIterator __last,
                                                 __false_type) {
    ...
    template <typename _InputIterator>
    _GLIBCXX20_CONSTEXPR void _M_assign_aux(_InputIterator __first,
                                            _InputIterator __last,
                                            std::input_iterator_tag);

    // Called by the second assign_dispatch above
    template <typename _ForwardIterator>
    _GLIBCXX20_CONSTEXPR void _M_assign_aux(_ForwardIterator __first,
                                            _ForwardIterator __last,
                                            std::forward_iterator_tag);
    ...
    // 438. Ambiguity in the "do the right thing" clause
    template <typename _Integer>
    _GLIBCXX20_CONSTEXPR void _M_insert_dispatch(iterator __pos, _Integer __n,
    ...
    // Called by the range insert to implement [23.1.1]/9
    template <typename _InputIterator>
    _GLIBCXX20_CONSTEXPR void _M_insert_dispatch(iterator __pos,
                                                 _InputIterator __first,
                                                 _InputIterator __last,
                                                 __false_type) {
    ...
    template <typename _InputIterator>
    _GLIBCXX20_CONSTEXPR void _M_range_insert(iterator __pos,
                                              _InputIterator __first,
                                              _InputIterator __last,
                                              std::input_iterator_tag);
    ...
    struct _Temporary_value {
      template <typename... _Args>
      _GLIBCXX20_CONSTEXPR explicit _Temporary_value(vector* __vec,
                                                     _Args&&... __args)
          : _M_this(__vec) {
      ...
      _GLIBCXX20_CONSTEXPR value_type& _M_val() noexcept {
        return _M_storage._M_val;
      }

     private:
      _GLIBCXX20_CONSTEXPR _Tp* _M_ptr() noexcept {
    ...
    _GLIBCXX20_CONSTEXPR void _M_insert_aux(iterator __position, _Arg&& __arg);

    template <typename... _Args>
    _GLIBCXX20_CONSTEXPR void _M_realloc_insert(iterator __position,
                                                _Args&&... __args);
    ...
    template <typename... _Args>
    _GLIBCXX20_CONSTEXPR iterator _M_emplace_aux(const_iterator __position,
                                                 _Args&&... __args);
    ...
    _S_check_init_len(size_type __n, const allocator_type& __a) {
      if (__n > _S_max_size(_Tp_alloc_type(__a)))
        __throw_length_error(
            __N("cannot create std::vector larger th an max_size()"));
      return __n;
    }

    static _GLIBCXX20_CONSTEXPR size_type _S_max_size(const _Tp_alloc_type& __a)
        _GLIBCXX_NOEXCEPT {
   ...
   */
  template <typename _Tp, typename _Alloc>
  _GLIBCXX20_CONSTEXPR inline bool operator==(const vector<_Tp, _Alloc>& __x,
   ...
   */
  template <typename _Tp, typename _Alloc>
  _GLIBCXX20_CONSTEXPR inline __detail::__synth3way_t<_Tp> operator<=>(
  ...
  /// See std::vector::swap().
  template <typename _Tp, typename _Alloc>
  _GLIBCXX20_CONSTEXPR inline void swap(vector<_Tp, _Alloc> & __x,
